  ...
  async function fetchData(view) {
    ...
    try {
      ...
      if (view === "Phase") {
        ...
        const phaseColors = projectTimelineData.reduce(
          (map, [, phaseName, , , , color]) => {
            if (!map[phaseName]) {
              map[phaseName] = color;
            }
        ...
        const milestoneTimelineData = data.flatMap((project) => {
          const projectName = project.projectName;
        ...
        const milestoneColors = milestoneTimelineData.reduce(
    ...
    <div style={{ overflowX: "auto" }}>
      <div style={{ marginBottom: "30px", textAlign: "center" }}>
        <Button
          ...
          style={{
            marginRight: "10px",
            fontWeight: selectedView === "Phase" ? "normal" : "normal",
          }}
        ...
        <Button
          ...
          style={{
            fontWeight: selectedView === "Milestone" ? "normal" : "normal",
          }}
        ...
        <div style={{ position: "relative" }}>
          <Chart
            ...
            options={{//PHASE
              ...
              legend:
                selectedView === "Phase" ? { position: "bottom" } : "none",
              tooltip: {
                ...
                html: ({ row, column }) =>
                  getTooltipContent(selectedView, row, column),
              },
            }}
            width="100%"
            height="300px"
